...
@Registers.block
class nasbench201_cifar100_optimal_forRes50_base(nn.Module):
    ...
    def __init__(self,in_channels,out_channels=None):
        ...
        self.op6=CustomConv2d(in_channels=in_channels,out_channels=in_channels,kernel_size=3,stride=1,dilation=1,groups=1)
        self.op7=BatchNorm2d(num_features=in_channels)
        self.op8=ReLU()
        self.op9=CustomConv2d(in_channels=in_channels,out_channels=in_channels,kernel_size=3,stride=1,dilation=1,groups=1)
        self.op10=BatchNorm2d(num_features=in_channels)
        self.op11=CustomConv2d(in_channels=in_channels,out_channels=in_channels,kernel_size=3,stride=1,dilation=1,groups=1)
