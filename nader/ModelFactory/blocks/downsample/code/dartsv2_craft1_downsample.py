...
@Registers.block
class dartsv2_craft1_downsample(nn.Module):
    ...
    def __init__(self,in_channels,out_channels,C_pre=None,reduction_pre=False):
        ...
        self.op6=ReLU()
        self.op7=CustomConv2d(in_channels=in_channels,out_channels=out_channels,kernel_size=1,stride=1,dilation=1,groups=1)
