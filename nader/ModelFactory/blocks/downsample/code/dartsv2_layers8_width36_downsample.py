...
@Registers.block
class dartsv2_layers8_width36_downsample(nn.Module):
    ...
    def __init__(self,in_channels,out_channels,C_pre=None,reduction_pre=False):
        ...
        self.op2=CustomMaxPool2d(kernel_size=3,stride=2)
        self.op3=CustomMaxPool2d(kernel_size=3,stride=2)
        self.op4=CustomMaxPool2d(kernel_size=3,stride=2)
        self.op5=CustomMaxPool2d(kernel_size=3,stride=2)
        self.op6=ReLU()
