...
@Registers.model
class darts_beta_layers8_width36(nn.Module):

    def __init__(self,num_classes=100,auxiliary=False) -> None:
        super().__init__()
        self.auxiliary = auxiliary
        base = Registers.block['darts_beta_layers8_width36_base']
        stem = Registers.block['darts_beta_layers8_width36_stem']
        downsample = Registers.block['darts_beta_layers8_width36_downsample']
        self.stem = stem(3,36)
