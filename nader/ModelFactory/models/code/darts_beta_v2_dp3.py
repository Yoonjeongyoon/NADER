...
@Registers.model
class darts_beta_v2_dp3(nn.Module):

    def __init__(self,num_classes=100,auxiliary=False) -> None:
        super().__init__()
        self.auxiliary = auxiliary
        base = Registers.block['darts_beta_v2_dp3_base']
        stem = Registers.block['darts_beta_v2_dp3_stem']
        downsample = Registers.block['darts_beta_v2_dp3_downsample']
        self.stem = stem(3,43)
